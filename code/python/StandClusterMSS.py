            ...
            if (i < size):
                for j in range(i+1,size):
                    if (Assignment[i] == Assignment[j]):
                        Avg_Dist_WC[Cluster_index[Assignment[i]]] = Avg_Dist_WC[Cluster_index[Assignment[i]]] + Dist_EU[i][j]
...
#                print(cl_i," ",i," ",j," ",Cluster_sizes[cl_i]," ",Kmed_small_ind[i]," ",Kmed_small_ind[j])
                    DistSmall[i][j] = Dist_EU[Kmed_small_ind[i]][Kmed_small_ind[j]]
...
#    print(Centers)
        ...
        Avg_Dist_FC = 0
        for i in range(size):
            Avg_Dist_FC = Avg_Dist_FC + Dist_EU[i][Centers[i]]
